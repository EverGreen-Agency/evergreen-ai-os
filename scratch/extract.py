...
with open(r'c:\Users\Lenovo\Desktop\EG\evergreen-ai-os\scratch\extracted.txt', 'w', encoding='utf-8') as out:
    for i in data['ideas']:
        if i.get('stage') in ['processing', 'evaluation'] and not i.get('archived'):
            out.write(f"ID: {i['id']}\n")
