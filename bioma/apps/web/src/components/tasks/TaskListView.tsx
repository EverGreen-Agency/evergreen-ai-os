  ...
  if (!tasks || tasks.length === 0) {
    return (
      <>
        ...
        {isCreating && (
          <TaskDrawer workspaceId={workspaceId} listId={listId} discipline={discipline as Discipline | undefined}
          listType={listType} taskId={null} onClose={() => setIsCreating(false)} />
        )}
      </>
    );
  }
