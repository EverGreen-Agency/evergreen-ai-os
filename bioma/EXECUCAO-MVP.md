...
| MARKET-RESEARCH-001 | DONE | Full-stack/Worker | Pesquisa de mercado tenant-scoped: refinamento assistido, relatório versionado com pesquisa web e fontes verificadas, playbook de prospecção, oportunidades Growth/Social e publicação HITL ao cliente | AUTHZ-WS-001 + FINOPS-AI-001 | `tests/test_market_research.py` + OpenAPI/tipos + tsc/build; execução live real depende de `OPENAI_API_KEY` |
